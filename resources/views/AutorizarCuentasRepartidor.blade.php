...
@section('AutorizarCuentasRepartidor')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="confirmacionRechazoModalLabel">Confirmar Rechazo</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ¿Estás seguro de que quieres rechazar este repartidor?
        </div>
...
<div class="modal fade" id="confirmacionAprobacionModal" tabindex="-1" role="dialog" aria-labelledby="confirmacionAprobacionModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="confirmacionAprobacionModalLabel">Confirmar Aprobación</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ¿Estás seguro de que quieres aprobar este repartidor?
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
...
<div class="modal fade" id="detallesModal" tabindex="-1" role="dialog" aria-labelledby="detallesModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="detallesModalLabel">Detalles del repartidor</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="head-title">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a class="active" href="#">Autorizar una cuenta de repartidores</a>
                    </li>
                </ul>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Documentacion</td>
                            <td>
                                <a href="#" class="status completed" data-toggle="modal" data-target="#confirmacionAprobacionModal">Aprobar</a>
                                <a href="#" class="status process" data-toggle="modal" data-target="#detallesModal">Ver detalles</a>
                                <a href="#" class="status pending" data-toggle="modal" data-target="#confirmacionRechazoModal">Rechazar</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
