...
@section('activacionDesactivacionRepartidor')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ¿Estás seguro de que quieres desactivar este repartidor?
        </div>
...
<div class="modal fade" id="confirmacionAprobacionModal" tabindex="-1" role="dialog" aria-labelledby="confirmacionAprobacionModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ¿Estás seguro de que quieres activar este repartidor?
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
...
<section id="content">
    ...
    <main>
        <div class="head-title">
            <div class="left">
                <h1>Activar cuentas de repartidores</h1>
                <ul class="breadcrumb">
                    <li>
                        <a href="#">Panel</a>
                    </li>
                    ...
                    <li>
                        <a class="active" href="#">Activar una cuenta de repartidor</a>
                    </li>
                </ul>
            </div>
